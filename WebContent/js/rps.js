 ...
 */
var RPS = {};
RPS.url="http://localhost:8080/rps/services/game";
...
RPS.createGame = function() {
	...
	if (playerTypeElementList.length > 0) {
		...
		$.post(RPS.url+"?playerType="+RPS.playerTypeMap[playerTypeValue], function( data ) { //RPS.playerTypeMap[playerTypeValue]
